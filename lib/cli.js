...
e.on("view foods", function(str) {
  cli.responders.viewFoods();
});
...
cli.responders.help = function() {
  ...
  var commands = {
    ...
    "View foods": "View all the menus",
    "View orders":
    "View orders. Available parameters --24|all|id. Usage example: view orders --all or view orders --id orderId",
    "List users":
    "List users. Available parameters --24|all|email. Usage example: list users --all or list users --email test@gmail.com"
  };
...
// View menus
cli.responders.viewFoods = function() {
  // Available foods
  var foods  =_data.foods((err, foods)=>{
